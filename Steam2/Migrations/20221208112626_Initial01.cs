        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GamesID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProfileID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Icon = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Achieved = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Acquired = table.Column<bool>(type: "bit", nullable: false),
                    PlayerPerc = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
